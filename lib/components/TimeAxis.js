...
var TimeAxis = function (_React$Component) {
    ...
    _createClass(TimeAxis, [{
        ...
        value: function renderTimeAxis(scale, format, showGrid, gridHeight) {
            ...
            .append("g").attr("class", "x axis").style("stroke", "none")
            // .styles(valueStyle)
            ...
            if (this.props.angled) {
                ...
                // .styles(valueStyle)
                .style("text-anchor", "end").attr("dx", "-1.2em").attr("dy", "0em").attr("transform", function (d) {
                    return "rotate(-65)";
                });
            } else {
                ...
                //   .select("text")
                //   .styles(valueStyle);
                var g = (0, _d3Selection.select)(_reactDom2.default.findDOMNode(this)) // eslint-disable-line
                .append("g").attr("class", "x axis").style("stroke", "none");
